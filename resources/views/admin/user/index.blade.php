            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ url('/admin/user'. '/create') }}" class="btn btn-success mr-2"><i class="fa fa-plus mr-1"></i>Tambah Baru</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table" id="table">
                            ...
                            <tr>
                                <th>No.</th>
                                <th>Nama</th><th>Email</th><th>Status</th>
                                <th>peran</th>
                                <th>Aksi</th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->role }}</td>
                                <td class="text-left">
                                <a href="{{ url('/admin/user/' . $item->id . '/edit') }}" class="btn btn-sm btn-warning btn-rounded mr-2">

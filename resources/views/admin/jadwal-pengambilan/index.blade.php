            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ url('/admin/jadwal-pengambilan'. '/create') }}" class="btn btn-success mr-2"><i class="fa fa-plus mr-1"></i> Buat Jadwal </a>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table" id="table">
                            ...
                            <tr>
                                ...
                                <td>{{ $item->status }}</td>
                                <td class="text-left">
                                <a href="{{ url('/admin/jadwal-pengambilan/' . $item->id) }}" class="btn btn-sm btn-primary btn-rounded mr-2">
                                    <i class="far fa-eye mr-1"></i> Lihat </a>
                                    @if($item->status == 'Sampah Telah Diambil')
                                    @else
                                <a href="{{ url('/admin/jadwal-pengambilan/' . $item->id . '/edit') }}" class="btn btn-sm btn-warning btn-rounded mr-2">

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table" id="table">
                            ...
                            <tr>
                                <th>No.</th>
                                <th>Nasabah</th><th>Jumlah</th><th>Kode</th><th>Status</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <tr>
                                <td>{{ $i+1 }}</td>
                                <td>{{ $item->nasabah->name }}</td><td>{{ $item->jumlah }}</td><td>{{ $item->kode }}</td><td>{{ $item->status }}</td>
                                <td class="text-left">
                                @if($item->status == 'Penarikan Diproses')
                                <button type="button" class="btn btn-sm btn-success btn-rounded mr-2" data-toggle="modal"
                                data-target="#izinkan{{$item->id}}"><i class="fa fa-close" aria-hidden="true"></i> Izinkan </button>
                                <div class="modal fade" id="izinkan{{$item->id}}" tabindex="-1" role="dialog"
                                aria-labelledby="modal-block-popout" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <form class="user" action="/admin/penarikan-saldo/izinkan/{{$item->id}}" method="post">
                                            @csrf
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            {!! Form::close() !!} --}}
                                            <button type="submit" class="btn btn-danger btn-sm">Izinkan</button>
                                        </div>
                                    </form>
                                    </div>
                                </div>
                        ...
                        <div class="modal fade" id="reject{{$item->id}}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form class="user" action="/admin/penarikan-saldo/reject/{{$item->id}}" method="post">
                                        @csrf
                                ...
                                <button type="button" class="btn btn-sm btn-success btn-rounded mr-2" data-toggle="modal"
                                    ...
                                    <div class="modal fade" id="approve{{$item->id}}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    Apa anda ingin menerima pengajuan penarikan saldo ini?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-warning btn-sm" data-dismiss="modal">Tutup</button>
                                                    {!! Form::open([

        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ url('/admin/kategori-sampah' . '/create') }}" class="btn btn-success mr-2"><i

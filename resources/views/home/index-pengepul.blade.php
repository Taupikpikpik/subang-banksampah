                        ...
                        <div class="card shadow-sm product mb-4">
                            <div class="card-body">
                                ...
                                <p class="mb-1">
                                    ...
                                    <small class="float-end"><span class="text-opac">Stok :
                                        </span>{{ $item->stok }}</small>
                                </p>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <p class="mb-0" style="font-size:14px !important;">Rp.
                                            {{ number_format($item->harga_jual, 2, ',', ',') }}<br><small
                                                class="text-opac">per 1 kg</small></p>
                                    </div>
                                    <div class="col-auto">
                                        <button
                                            class="btn btn-sm avatar before-beli avatar-30 p-0 rounded-circle shadow btn-gradient"
                                            data-bs-toggle="modal" data-bs-target="#addproductcart{{ $item->id }}">
                        ...
                        <div class="modal-dialog modal-sm modal-dialog-centered">
                            ...
                            <div class="modal-content product border-0 shadow-sm">
                                <figure class="text-center mb-0 px-5 py-3">
                                    <img src="{{ asset('uploads/images') }}/{{ $item->kategori->icon }}"
                                        alt="" class="mw-100">
                                </figure>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <div class="counter-number">
                                                ...
                                                <button
                                                    class="btn btn-sm avatar avatar-30 p-0 rounded-circle decrease-btn{{ $item->id }}"
                                                    type="button">
                                                ...
                                                <button
                                                    class="btn btn-sm avatar avatar-30 p-0 rounded-circle increase-btn{{ $item->id }}"
                                                    type="button">
                                                    <i class="bi bi-plus size-22"></i>
                                                </button>
                                            </div>
                                ...
                                <div class="modal-footer justify-content-center">
                                    <button class="btn btn-link text-color-theme do-beli"
                                        data-id_sampah="{{ $item->id }}"
                                        data-nama_sampah="{{ $item->nama_sampah }}" type="button">BELI</button>
                                </div>
                            </div>
                        </div>
                    </div>

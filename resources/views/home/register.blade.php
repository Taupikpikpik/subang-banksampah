                ...
                <div class="row h-100">
                    <div class="col-10 col-sm-8 col-md-6 col-lg-4 col-xl-3 mx-auto align-self-center">
                        ...
                        <div class="card card-light shadow-sm mb-4">
                            <div class="card-body">
                                <form class="was-validated" method="post" action="{{route('register.user')}}">
                                    {{ csrf_field() }}
                                    <div class="form-floating mb-3">
                                        <input type="name" class="form-control" placeholder="name@example.com" name="name" required>
            ...
            <div class="col-12 text-center align-self-end py-2">
                <div class="row">
                    <div class="col text-center">
                        Sudah memili akun? <a href="{{route('login.page')}}" class="btn btn-link px-0 ms-2">Login <i class="bi bi-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>

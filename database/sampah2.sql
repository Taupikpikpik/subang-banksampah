...
-- Dumping data for table bank-sampah.pembelian_sampahs: ~6 rows (approximately)
...
INSERT INTO `pembelian_sampahs` (`id`, `created_at`, `updated_at`, `id_sampah`, `id_pengepul`, `kuantitas`, `total`, `status_pembelian`, `kode_pembelian`) VALUES
	(34, '2023-07-04 20:59:27', '2023-07-04 20:59:27', 1, 6, NULL, 0, 'Menunggu Pengambilan Di Bank Sampah', 'K64OEZ');
INSERT INTO `pembelian_sampahs` (`id`, `created_at`, `updated_at`, `id_sampah`, `id_pengepul`, `kuantitas`, `total`, `status_pembelian`, `kode_pembelian`) VALUES
	(35, '2023-07-04 21:01:48', '2023-07-04 21:01:48', 1, 6, NULL, 0, 'Menunggu Pengambilan Di Bank Sampah', 'W76OSR');
INSERT INTO `pembelian_sampahs` (`id`, `created_at`, `updated_at`, `id_sampah`, `id_pengepul`, `kuantitas`, `total`, `status_pembelian`, `kode_pembelian`) VALUES
	(36, '2023-07-04 21:01:48', '2023-07-04 21:01:48', 1, 6, NULL, 0, 'Menunggu Pengambilan Di Bank Sampah', 'Y27WWV');
INSERT INTO `pembelian_sampahs` (`id`, `created_at`, `updated_at`, `id_sampah`, `id_pengepul`, `kuantitas`, `total`, `status_pembelian`, `kode_pembelian`) VALUES
	(37, '2023-07-04 21:03:53', '2023-07-04 21:03:53', 1, 6, 5, 35000, 'Menunggu Pengambilan Di Bank Sampah', 'V55BJL');
...
-- Dumping data for table bank-sampah.saldos: ~4 rows (approximately)
...
-- Dumping data for table bank-sampah.transaksi_sampahs: ~4 rows (approximately)
...
-- Dumping data for table bank-sampah.users: ~8 rows (approximately)
INSERT INTO `users` (`id`, `name`, `email`, `role`, `password`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'Admin', 'admin@admin.com', 'admin', '$2y$10$gaewMzlWbLokpM0isxkIYem/q.wX/w5kIZKxFnzmOXMAMnO9ifDJu', 'Bekasi', 'active', NULL, '2023-07-06 07:12:11');
INSERT INTO `users` (`id`, `name`, `email`, `role`, `password`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(4, 'Muhammad Ramdhan Syakirin', 'djeldrago22@gmail.com', 'nasabah', '$2y$10$gaewMzlWbLokpM0isxkIYem/q.wX/w5kIZKxFnzmOXMAMnO9ifDJu', 'Premier Savanna Blok O', 'active', '2023-06-20 22:39:40', '2023-07-06 07:14:27');
INSERT INTO `users` (`id`, `name`, `email`, `role`, `password`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(5, 'Petugas', 'petugas@gmail.com', 'petugas', '$2y$10$7ccL.WOl7WEcmfP4vEthXO5EiBGX9Zr.GBVSMR9SMW2OhN6J7eOGG', '', 'active', '2023-06-22 10:39:45', '2023-06-22 10:39:45');
INSERT INTO `users` (`id`, `name`, `email`, `role`, `password`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(6, 'Pengepul', 'pengepul@gmail.com', 'pengepul', '$2y$10$gaewMzlWbLokpM0isxkIYem/q.wX/w5kIZKxFnzmOXMAMnO9ifDJu', '', 'active', '2023-06-22 10:40:01', '2023-06-22 10:40:01');
INSERT INTO `users` (`id`, `name`, `email`, `role`, `password`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(7, 'Dirut Lingkungan Hidup', 'dirut@gmail.com', 'reviewer', '$2y$10$m2eZGus9oY5xyO2crloEfOEYx98uSYVBpNcLFhczgpql3Vzi1tShS', '', 'active', '2023-06-22 10:40:27', '2023-06-22 10:40:27');
INSERT INTO `users` (`id`, `name`, `email`, `role`, `password`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(8, 'Safa Aulia', 'safa@gmail.com', 'nasabah', '$2y$10$m2eZGus9oY5xyO2crloEfOEYx98uSYVBpNcLFhczgpql3Vzi1tShS', 'Jakarta Selatan', 'active', '2023-07-02 07:15:06', '2023-07-02 07:15:06');
INSERT INTO `users` (`id`, `name`, `email`, `role`, `password`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(9, 'Taupik', 'taupik@gmail.com', 'nasabah', '$2y$10$zN8XIzM/JeRRLtJlwbQ0O.0hePmZIQaoIIXuwrlor49X.vDvEL15C', 'Subang', 'active', '2023-07-02 19:53:07', '2023-07-02 19:53:07');
INSERT INTO `users` (`id`, `name`, `email`, `role`, `password`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(10, 'Sekretaris LH', 'carla@gmail.com', 'reviewer', '$2y$10$gYAy9Njo.wez.8.fvpqi..6Lt29/i4STmEqPCjXZo6eKB2gANs69q', 'Disitu', 'active', '2023-07-05 20:41:13', '2023-07-05 20:41:13');
